namespace Crawler
{
    ...
    public class DataSeederCL1718 : TeamsDataSeeder, ICrawler
    {
        public void CrawlTeamsData()
        {
            ...
            var url = "http://www.uefa.com/uefachampionsleague/season=2018/clubs/index.html";
            var documentAllTeams = browsingContext.OpenAsync(url).Result;

            var allTeamsElements = new List<string>();
            var allTeamsDiv = documentAllTeams.QuerySelectorAll(".teams-overview_teams-wrapper").FirstOrDefault();
